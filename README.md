# מערכת חישוב זכאות להחזר כספי (Refund System)
...
**מאגר הפרויקט:** [יש להוסיף כאן את קישור המאגר לאחר העלאה ל-Git]
...
1. פתחו את **SQL Server Management Studio**  והתחברו לשרת.
...
האפליקציה תיפתח בדפדפן, בדרך כלל בכתובת **http://localhost:3000**.
...
- **מסך התחברות לפי תעודת זהות** – מזינים ת.ז. בלבד; המערכת בודקת אם זה פקיד או אזרח ומפנה בהתאם: תז של פקיד → מסך הפקיד (רשימת בקשות ממתינות), תז של אזרח → מסך האזרח (היסטוריית בקשות, יצירת בקשה חדשה).
